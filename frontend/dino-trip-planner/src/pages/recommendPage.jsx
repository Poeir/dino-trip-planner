...
export default function RecommendPage() {
  ...
  const handleNextClick = () => {
    // Navigate to the next page (e.g., plan-summary)
    navigate("/summary");
  };
    ...
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="mt-6 mb-6 inline-flex items-center gap-2 px-5 py-2.5 bg-green-700 hover:bg-green-600 text-white rounded-full text-sm font-medium transition-all duration-200 hover:shadow-lg"
        >
          <span>←</span>
          <span>ย้อนกลับ</span>
        </button>
